    ...
    <>
      ...
      <div className="font-nunito px-6">
        <div className="flex flex-col items-center justify-center ">
          <h1 className="font-bold text-3xl text-[#0a5d4f] -z-20">PROJECTS</h1>
          <hr className="border-[#0a5d4f] border-2 rounded-2xl opacity-50 w-20 flex flex-col -z-20 "></hr>
          <p className="text-sm opacity-60 max-w-md text-center flex flex-col -z-20 ">
                ...
                <div className="xl:flex xl:w-[500px]">
                  ...
                  <div className="xl:ml-6 xl:flex flex-col xl:justify-center ">
                    ...
                    <div className="">
                      ...
                      <a href="https://www.figma.com/file/megnFvM1YKCVSRLz1GcHK3/Projek-PKL?type=design&node-id=0%3A1&mode=design&t=IvKVgzVo5m7TQiYx-1">
                ...
                <div className="xl:flex xl:w-[500px]">
                  ...
                  <div className="xl:ml-6 xl:flex flex-col xl:justify-center ">
                    ...
                    <div className="w-fit">
                      ...
                      <a href="https://github.com/Bastianreal/Project-Web-Pribadi">
                        <button className="border-4 border-[#ede7de]  hover:bg-[#ede7de] rounded-lg font-bold w-28 h-12 hover:text-[#0a5d4f] transition duration-500 text-md text-[#ede7de] xl:mt-2">
                          Check It Out
                        </button>
                      </a>
            ...
            <div className="bg-[#0a5d4f] w-full xl:w-[1000px] rounded-lg p-5 drop-shadow-lg hover:translate-y-2 duration-500">
              <div className="mt-3">
                <div className="xl:flex xl:w-[500px]">
                  ...
                  ></Image>
                  <div className="xl:ml-6 xl:flex flex-col xl:justify-center">
                    <h1 className="font-bold text-white text-2xl">Scratch</h1>
                    <div className="w-fit">
                      <p className="text-white mt-0.5 xl:w-96">
                        This is another project for the end of semester but we
                        did this in a group we make a basic scratch game named
                        Crazy Cars
                      </p>
                      <a href="https://scratch.mit.edu/projects/939327427">
                        <button className="border-4 border-[#ede7de]  hover:bg-[#ede7de] rounded-lg font-bold w-28 h-12 hover:text-[#0a5d4f] transition duration-500 text-md text-[#ede7de] xl:mt-2">
                          Check It Out
                        </button>
                      </a>
